...
#' 
#' @details The test below assumes that the net squared displacement (NSD) for a 
#' migrating organism is well characterized by the logistic formula: 
#' \deqn{E(NSD(t)) = \frac{a}{1 + \exp((b-t)/c)}} as described in Boerger and Fryxell (2012).  
#' In practice, the square root of the NSD, i.e., the linear displacement, is 
#' fitted to the square root of the formula assuming Gaussian residuals with constant 
#' variance 's'.  A likelihood ratio test against a null model of no-dispersal is 
#' provided at a 95\% significance level.
#' @param T time
...
#' @encoding UTF-8
#' @references Boerger, L. & Fryxell, J. (2012) Quantifying individual differences 
#' in dispersal using net squared displacement. Dispersal Ecology and Evolution 
#' (eds. J. Clobert, M. Baguette, T. Benton & J. Bullock), pp. 222-228. Oxford University 
#' Press, Oxford, UK.
#'
